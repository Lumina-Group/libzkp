...
use crate::utils::{
    ...
    proof_helpers::{extract_bulletproofs_components, create_proof},
};
use pyo3::prelude::*;
...
pub fn verify_range(proof: Vec<u8>, min: u64, max: u64) -> PyResult<bool> {
    use crate::utils::proof_helpers::{parse_and_validate_proof, reconstruct_bulletproofs_proof, validate_standard_commitment};
